...
def generate_launch_description():
    ...
    def _make_bag_record_action(context, *args, **kwargs):
        ...
        topics = [
            ...
            '/navigate_to_pose/_action/result',         # P2: RC = number_of_recoveries (bag_to_rc.py)
            '/navigate_to_pose/_action/cancel_response',
            '/navigate_to_pose/_action/status',
            '/navigate_through_poses/_action/feedback',
            '/navigate_through_poses/_action/result',
            '/navigate_through_poses/_action/cancel_response',
